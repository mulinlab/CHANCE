...
dataset = pd.read_table("../output/09_feature_used.txt.gz")
dataset.head
...
dataset.to_csv("../output/10_predict.txt",sep="\t",index=None)
...
key_info1.to_csv("../output/10_predict_key_info.txt",sep="\t",index=None)
...
feature_shap.to_csv("../output/10_feature_importance_shap.txt",sep="\t",index=None)